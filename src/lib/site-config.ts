...
export const SITE_DESCRIPTION =
  "Имоти Надежда — агенция за недвижими имоти в Шумен, Варна, Бургас и Нови пазар. Купувайте и продавайте апартаменти, къщи, офиси и парцели.";
...
const CITY_SEO: Record<string, { title: string; description: string }> = {
  ...
  "novi-pazar": {
    title: "Имоти в Нови пазар | Имоти Надежда — агенция недвижими имоти",
    description:
      "Имоти в Нови пазар и региона — апартаменти и къщи от агенция Имоти Надежда. Личен подход и актуални оферти.",
  },
};
