...
function LoginPage() {
  ...
  const videoSources: Record<"4k" | "8k", string> = {
    "4k": resolveAssetUrl(crmHeroVideoMp4) || loginHeroPoster,
    "8k": resolveAssetUrl(crmHeroVideoMp4) || loginHeroPoster,
  };
  const videoSourceWebm = resolveAssetUrl(crmHeroVideoWebm) || "";
