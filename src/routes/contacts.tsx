...
export const Route = createFileRoute("/contacts")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Свържете се с Имоти Надежда — телефон, имейл и офиси в Шумен, Варна и Бургас.",
      },
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#fbf6ea] to-white">
      ...
      <div className="mx-auto max-w-5xl px-4 pb-16 pt-8 md:px-8">
        ...
        <p className="mt-2 text-[15px] text-[#2b1418]/80">
          Пишете ни, обадете се или заповядайте в офиса.
        </p>

        <div className="mt-8 grid gap-6 md:grid-cols-2">
          <div className="space-y-4 rounded-2xl border border-[#C9A84C]/40 bg-white p-6">
            <div>
              <div className="text-xs uppercase tracking-widest text-[#2b1418]/60">
                Централен офис
              </div>
              <div className="mt-1 font-display text-lg text-[#8B1A2B]">
                гр. Шумен, ул. „Съединение" 5
              </div>
            </div>
            <div>
              <div className="text-xs uppercase tracking-widest text-[#2b1418]/60">Телефон</div>
              <a
                href="tel:+359899620262"
                className="mt-1 block font-display text-lg text-[#8B1A2B] hover:underline"
              >
                +359 899 620 262
              </a>
            </div>
            <div>
              ...
              <a
                href="mailto:office@nadezhda.bg"
                className="mt-1 block font-display text-lg text-[#8B1A2B] hover:underline"
              >
                office@nadezhda.bg
              </a>
            ...
            <div>
              ...
              <div className="mt-1 text-sm text-[#2b1418]/80">
                Пон – Пет: 09:00 – 18:00
                <br />
                Съб: 10:00 – 14:00
              </div>
          ...
          <form
            onSubmit={submit}
            className="space-y-3 rounded-2xl border border-[#C9A84C]/40 bg-white p-6"
          >
