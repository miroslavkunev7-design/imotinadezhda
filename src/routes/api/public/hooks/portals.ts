// Автоматизация №7 — cron hook: синхронизира опашката от обяви към порталите.
...
async function run(limit?: number) {
  ...
  return runPortalsSync(limit);
}

export const Route = createFileRoute("/api/public/hooks/portals")({
  server: {
    handlers: {
      POST: async ({ request }) => {
