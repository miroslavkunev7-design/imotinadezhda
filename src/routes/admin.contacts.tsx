              ...
              <MarbleCard key={c.id}>
                <div className="flex items-start justify-between gap-3">
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="mt-1 truncate font-display text-lg text-[#4A1217]">
                      {c.company_name}
                    </div>
                    {c.contact_person && (
      ...
      <Dialog open={!!editing} onOpenChange={(o) => !o && setEditing(null)}>
        <DialogContent className="max-w-lg bg-white">
          ...
          {editing && (
            <div className="grid gap-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <Field
                  label="ДДС №"
                  value={editing.vat_number ?? ""}
                  onChange={(v) => setEditing({ ...editing, vat_number: v })}
                />
              </div>
              <Field
                label="Адрес"
          ...
          <DialogFooter>
            ...
            <Button onClick={handleSave} className="gold-cta-button">
              Запази
            </Button>
          </DialogFooter>
        </DialogContent>
      ...
      <Dialog open={newGroupOpen} onOpenChange={setNewGroupOpen}>
        <DialogContent className="max-w-sm bg-white">
          ...
          <Input
            ...
            placeholder="напр. Адвокати"
          />
          <DialogFooter>
            <Button variant="outline" onClick={() => setNewGroupOpen(false)}>
              Отказ
            </Button>
            <Button onClick={handleAddGroup} className="gold-cta-button">
              Добави
            </Button>
          </DialogFooter>
        </DialogContent>
