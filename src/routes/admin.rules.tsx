    ...
    <div className="mx-auto w-full max-w-5xl space-y-6 p-2">
        ...
        <div className="relative flex items-start gap-4">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-1 text-sm text-red-100/85">
              Десктоп · Таблет · Мобилен · Mobile App · Mobile Loyalt · App за компютър. Изключение
              само при изрично указание „само за X версия".
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="rounded-2xl border border-amber-500/20 bg-[rgba(20,4,8,0.4)] p-4">
        <p className="text-xs text-amber-100/60">
          💡 Тези правила се пазят в паметта на AI агента и се прилагат автоматично при всеки нов
          разговор. За промяна на правило — кажи на агента и той ще обнови записа.
        </p>
      </div>
    </div>
  );
