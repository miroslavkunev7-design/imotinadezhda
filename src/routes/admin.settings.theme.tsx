  ...
  const { data, isLoading, refetch } = useQuery({
    ...
    queryFn: async () => {
      ...
      return {
        tokens: {
          ...DEFAULT_TOKENS,
          ...((data?.tokens as Partial<ThemeTokens>) ?? {}),
        } as ThemeTokens,
        presets: {
          ...DEFAULT_PRESETS,
          ...((data?.presets as Partial<ThemePresets>) ?? {}),
        } as ThemePresets,
      };
    },
  });
        ...
        <TabsContent value="colors" className="space-y-4 pt-4">
          <div className="rounded-2xl border border-amber-500/25 bg-[rgba(20,4,8,0.4)] p-4">
            ...
            <p className="mb-3 text-xs text-amber-100/60">
              Промените се прилагат веднага. Натисни „Запази темата", за да ги направиш постоянни за
              всички. Auto-contrast гарантира че текстът никога няма да изчезне на фона.
            </p>
            ...
            <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setTokens({ ...tokens, fontSizeBase: Number(e.target.value) })}
