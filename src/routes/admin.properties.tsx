      ...
      {editing && (
        <div className="fixed inset-0 z-50 flex items-stretch justify-center bg-[#8B1A2B]/55 backdrop-blur-sm p-0 sm:items-center sm:p-4" onClick={() => setEditing(null)}>
          <form
            ...
            onSubmit={save}
            className="marble-light-panel relative flex w-full max-w-2xl flex-col text-slate-800 h-[calc(100dvh-5rem-env(safe-area-inset-bottom,0px))] max-h-[calc(100dvh-5rem-env(safe-area-inset-bottom,0px))] lg:h-[calc(100dvh-2rem)] lg:max-h-[calc(100dvh-2rem)] sm:rounded-2xl"
          >
