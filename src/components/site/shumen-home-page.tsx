...
function ShumenInfoBox() {
  return (
    <div className="absolute right-4 md:right-8 lg:right-12 top-28 md:top-40 lg:top-44 w-[92%] max-w-[420px] lg:max-w-[450px] nadezhda-dark-red-bg p-6 md:p-7 lg:p-8 rounded-3xl border border-[#c59441] text-white font-sans-nadezhda shadow-2xl z-30">
